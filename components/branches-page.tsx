          ...
          {canManage ? (
            <Panel title="Create branch" icon={Building2}>
              <form onSubmit={saveBranch} className="grid gap-4">
                ...
                <button disabled={saving} className="min-h-12 rounded bg-gumleaf px-4 py-3 text-sm font-semibold text-white hover:bg-[#1d625d] disabled:cursor-not-allowed disabled:opacity-60">
                  Save branch
                </button>
              </form>
            </Panel>
