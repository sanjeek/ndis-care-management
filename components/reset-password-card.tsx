        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          ...
          {recoveryState === "ready" ? (
            <>
              ...
              <button className="mt-6 w-full rounded bg-gumleaf px-4 py-3 font-semibold text-white hover:bg-[#1d625d] disabled:cursor-not-allowed disabled:opacity-70" disabled={loading}>
