        ...
        <section className="space-y-6">
          {canManageMedicationList ? (
            <Panel title="Add medication" icon={ClipboardPlus}>
              <form onSubmit={submitMedication} className="grid gap-4">
                ...
                <button className="rounded bg-gumleaf/10 border border-gumleaf/20 px-4 py-3 text-sm font-semibold text-gumleaf hover:bg-gumleaf/20">Save medication</button>
              </form>
            </Panel>
          ) : (
          ...
          <Panel title="Record administration or issue" icon={AlertTriangle}>
            <form onSubmit={submitEvent} className="grid gap-4">
              ...
              <button className="rounded bg-gumleaf/10 border border-gumleaf/20 px-4 py-3 text-sm font-semibold text-gumleaf hover:bg-gumleaf/20">Save medication event</button>
            </form>
          </Panel>
        </section>
