...
const teamLeaderRoutes = ["/dashboard", "/branches", "/rostering", "/participant-matching", "/timesheets", "/payroll", "/travel", "/training-records", "/emergency-contacts", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile", "/unauthorised"];
const teamLeaderNavOrder = ["/dashboard", "/branches", "/rostering", "/participant-matching", "/timesheets", "/payroll", "/travel", "/training-records", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile"];
