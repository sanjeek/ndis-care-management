...
const teamLeaderNavOrder = ["/dashboard", "/branches", "/timesheets", "/payroll", "/travel", "/training-records", "/participant-matching", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile"];
