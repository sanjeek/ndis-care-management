...
const workerNavOrder = ["/worker-portal", "/my-shifts", "/travel", "/training-records", "/emergency-contacts", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/care-plans", "/medications", "/progress-notes", "/incident-reports", "/risk-assessments", "/support-coordination", "/profile"];
const teamLeaderRoutes = ["/dashboard", "/branches", "/timesheets", "/payroll", "/travel", "/training-records", "/emergency-contacts", "/participant-matching", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile", "/unauthorised"];
const teamLeaderNavOrder = ["/dashboard", "/branches", "/timesheets", "/payroll", "/travel", "/training-records", "/emergency-contacts", "/participant-matching", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile"];
