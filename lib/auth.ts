...
const teamLeaderRoutes = ["/dashboard", "/timesheets", "/medications", "/service-agreements", "/profile", "/unauthorised"];
const teamLeaderNavOrder = ["/dashboard", "/timesheets", "/medications", "/service-agreements", "/profile"];
