...
const workerRoutes = ["/worker-portal", "/my-shifts", "/travel", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/participants", "/care-plans", "/medications", "/progress-notes", "/incident-reports", "/risk-assessments", "/support-coordination", "/profile", "/unauthorised"];
const workerNavOrder = ["/worker-portal", "/my-shifts", "/travel", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/care-plans", "/medications", "/progress-notes", "/incident-reports", "/risk-assessments", "/support-coordination", "/profile"];
const teamLeaderRoutes = ["/dashboard", "/branches", "/timesheets", "/payroll", "/travel", "/participant-matching", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile", "/unauthorised"];
const teamLeaderNavOrder = ["/dashboard", "/branches", "/timesheets", "/payroll", "/travel", "/participant-matching", "/visitors", "/vehicles", "/shift-attachments", "/checklists", "/messages", "/tasks", "/participant-goals", "/medications", "/incident-reports", "/risk-assessments", "/support-coordination", "/service-agreements", "/profile"];
